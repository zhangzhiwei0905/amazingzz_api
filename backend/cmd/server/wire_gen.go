...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	announcementImageObjectStoreFactory := repository.NewS3AnnouncementImageStoreFactory()
	announcementImageService := service.NewAnnouncementImageService(settingRepository, announcementImageObjectStoreFactory)
	adminAnnouncementHandler := admin.NewAnnouncementHandler(announcementService, announcementImageService)
